...
def train(args):
    ...
    if condition_config is not None:
        ...
        if 'neuron' in condition_types:
            validate_allen_config(condition_config)
    ...
    for epoch_idx in range(num_epochs):
        ...
        for data in tqdm(data_loader):
            ...
            if 'neuron' in condition_types:
                with torch.no_grad():
                    assert 'neuron' in cond_input, 'Conditioning Type Neuron but no neuron conditioning input present'
                    validate_neuron_config(condition_config)
                    cond_input['neuron'] = cond_input['neuron'].to(device)
